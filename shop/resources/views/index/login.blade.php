				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							{{session('msg')}}
							<form class="sui-form" method="post" action="{{url('user/loginInfo')}}">
								@csrf
								<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" type="text" name="account" placeholder="邮箱/用户名/手机号" class="span2 input-xfat">
								</div>
								...
								<div class="logined">
									<a href="https://github.com/login/oauth/authorize?client_id=fc8edd088ec11c0bd3cc&https://github.com/login/oauth/access_token">github登录</a>
									<a class="sui-btn btn-block btn-xlarge btn-danger" href="javascript:;">
							...
							<div class="otherlogin">
								...
								<span class="register"><a href="javascript:;" target="_blank">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
